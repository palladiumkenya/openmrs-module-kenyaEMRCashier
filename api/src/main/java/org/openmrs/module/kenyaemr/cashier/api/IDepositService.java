...
public interface IDepositService extends IEntityDataService<Deposit> {
    /**
     * Gets all deposits.
     * @param includeVoided Whether to include voided deposits.
     * @return A list of deposits.
     * @should return all deposits
     * @should return an empty list if no deposits are found
     */
    @Authorized(PrivilegeConstants.VIEW_DEPOSITS)
    List<Deposit> getAll(Boolean includeVoided);
    ...
    /**
     * Gets all deposits for a patient by patient id.
     ...
     */
    @Authorized(PrivilegeConstants.VIEW_DEPOSITS)
    List<Deposit> getDepositsByPatientId(Integer patientId, PagingInfo pagingInfo);
